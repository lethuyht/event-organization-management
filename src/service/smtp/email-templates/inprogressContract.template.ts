export const InprogressContractTemplate = `<html>
<head>
  ...
  <div class="wrapper"
    ...
    <div class="container" style="width: 600px;
      ...
      text-align: left;">
        ...
        <div class="content">
             <p>Hợp đồng {{contractCode}} đã được Admin xác thực thành công</p>
            ...
            <p>Cảm ơn bạn vì đã tin tưởng và lựa chọn dịch vụ của chúng tôi. Chúng tôi sẽ nhanh chóng setup và cập nhập trạng thái hợp đồng sớm nhất có thể.</p>
